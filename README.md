...
```bash
$ whoami
> Full-Stack Developer crafting scalable web apps & backend systems
```

- 🔭 Currently building **full-stack applications** with the MERN stack & Spring Boot
- 🐧 Daily-driving **Arch Linux** (Omarchy) with Hyprland, Neovim & tmux
- 🌱 Always exploring better system design, cleaner APIs, and sharper UIs
- 💬 Ask me about **REST APIs, MongoDB aggregations, Spring Security, or Linux scripting**
